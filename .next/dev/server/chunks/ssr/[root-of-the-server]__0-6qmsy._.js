...
(()=>{
    const e = new Error("Cannot find module '../../data/certifications'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module '../../data/products'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module '../../data/articles'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
;
...
function generateStaticParams() {
    return certifications.filter((cert)=>cert.enabled).map((cert)=>({
            slug: cert.slug
        }));
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0-6qmsy._.js.map